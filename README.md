...
## Sobre o Controle de Acesso e Autenticação

No PHP é possivel programar um sistema de autenticação visando controle de acesso às páginas usando um recurso chamado de **SESSÃO**.
